...
describe("keyboard shortcuts settings", () => {
  ...
  beforeEach(() => {
    ...
    persisted = {
      app: { language: "en", theme: "dark", density: "comfortable", confirmDestructiveActions: true, browserHome: "https://pi.dev", openLastSessionOnStartup: false, enterToSend: true, openLinksInApp: true, closeToTray: true },
